...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','calc.py',68),
  ('statement -> expression','statement',1,'p_statement_expr','calc.py',73),
  ...
  ('expression -> - expression','expression',2,'p_expression_uminus','calc.py',93),
  ('expression -> ( expression )','expression',3,'p_expression_group','calc.py',98),
  ('expression -> NUMBER','expression',1,'p_expression_number','calc.py',103),
  ('expression -> NAME','expression',1,'p_expression_name','calc.py',108),
]
